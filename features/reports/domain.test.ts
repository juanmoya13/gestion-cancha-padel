...
function sale(id: string, date: string, status: SaleWithItems["status"] = "COMPLETADO"): SaleWithItems { return { id, date, responsible_player_id: "p1", payment_method: "EFECTIVO", total_amount: 1000, status, notes: null, created_at: date, responsiblePlayer: { first_name: "Ana", last_name: "Pádel" }, items: [{ id: `i-${id}`, sale_id: id, product_id: product.id, quantity: 1, unit_price: 1000, subtotal: 1000, product }] }; }
